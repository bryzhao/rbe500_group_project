...
#include "rrbot_gazebo/srv/detail/joint_velocity_input__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rrbot_gazebo::srv::JointVelocityInput_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rrbot_gazebo::srv::JointVelocityInput_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rrbot_gazebo::srv::JointVelocityInput_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JointVelocityInput_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rrbot_gazebo::srv::JointVelocityInput_Request *>(
...
static size_t _JointVelocityInput_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JointVelocityInput_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _JointVelocityInput_Request__callbacks = {
  "rrbot_gazebo::srv",
...
static rosidl_message_type_support_t _JointVelocityInput_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JointVelocityInput_Request__callbacks,
...
{
  return &rrbot_gazebo::srv::typesupport_fastrtps_cpp::_JointVelocityInput_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rrbot_gazebo::srv::JointVelocityInput_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rrbot_gazebo::srv::JointVelocityInput_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rrbot_gazebo::srv::JointVelocityInput_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JointVelocityInput_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rrbot_gazebo::srv::JointVelocityInput_Response *>(
...
static size_t _JointVelocityInput_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JointVelocityInput_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _JointVelocityInput_Response__callbacks = {
  "rrbot_gazebo::srv",
...
static rosidl_message_type_support_t _JointVelocityInput_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JointVelocityInput_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &rrbot_gazebo::srv::typesupport_fastrtps_cpp::_JointVelocityInput_Response__handle;
}
...
static service_type_support_callbacks_t _JointVelocityInput__callbacks = {
  "rrbot_gazebo::srv",
  "JointVelocityInput",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rrbot_gazebo, srv, JointVelocityInput_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rrbot_gazebo, srv, JointVelocityInput_Response)(),
...
static rosidl_service_type_support_t _JointVelocityInput__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JointVelocityInput__callbacks,
...
{
  return &rrbot_gazebo::srv::typesupport_fastrtps_cpp::_JointVelocityInput__handle;
}
