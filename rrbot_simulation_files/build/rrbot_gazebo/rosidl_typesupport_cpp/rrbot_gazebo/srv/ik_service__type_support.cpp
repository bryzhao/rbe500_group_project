...
static const _IKService_Request_type_support_symbol_names_t _IKService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rrbot_gazebo, srv, IKService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rrbot_gazebo, srv, IKService_Request)),
  }
};
...
{
  return &::rrbot_gazebo::srv::rosidl_typesupport_cpp::IKService_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rrbot_gazebo, srv, IKService_Request)() {
  return get_message_type_support_handle<rrbot_gazebo::srv::IKService_Request>();
}
...
static const _IKService_Response_type_support_symbol_names_t _IKService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rrbot_gazebo, srv, IKService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rrbot_gazebo, srv, IKService_Response)),
  }
};
...
{
  return &::rrbot_gazebo::srv::rosidl_typesupport_cpp::IKService_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rrbot_gazebo, srv, IKService_Response)() {
  return get_message_type_support_handle<rrbot_gazebo::srv::IKService_Response>();
}
...
static const _IKService_type_support_symbol_names_t _IKService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rrbot_gazebo, srv, IKService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rrbot_gazebo, srv, IKService)),
  }
};
...
{
  return &::rrbot_gazebo::srv::rosidl_typesupport_cpp::IKService_service_type_support_handle;
}
